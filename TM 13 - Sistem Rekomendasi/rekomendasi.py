...
ratings = pd.read_csv(r'D:\Coolyeah\Mata Kuliah\SMT 4\Machine Learning Praktikum\Modul 8\ratings.csv')
movies = pd.read_csv(r'D:\Coolyeah\Mata Kuliah\SMT 4\Machine Learning Praktikum\Modul 8\movies.csv')
